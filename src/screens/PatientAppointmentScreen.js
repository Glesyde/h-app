...
import tailwind from 'tailwind-rn'; // Assuming you have Tailwind-RN set up
...
const PatientAppointmentScreen = () => {
  ...
  return (
    <View style={tailwind('flex-1 bg-white p-4')}>
      <Text style={tailwind('text-2xl font-bold mb-4')}>Patient Appointments</Text>
        ...
        {appointments.map((appointment) => (
          <View key={appointment.id} style={tailwind('bg-gray-100 p-4 mb-4 rounded')}>
            <View style={tailwind('flex-row items-center mb-2')}>
              <Image
                source={{ uri: 'https://placekitten.com/50/50' }} // Placeholder image for doctor
